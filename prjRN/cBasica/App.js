...
export default function App() {
  ...
  const [resultado, setResultado] = useState(0);//es mejor que arranque desde 0 
  const [esValido,setesValido] = useState(true); // es para verificar el error
    ...
    <View style={styles.container}>
      ...
      <View style={[styles.container, { flex: 5, backgroundColor: 'powderblue' }]}>
        ...
        <View style={[styles.container, { marginTop: 20, flexDirection: 'row' }]}>
          ...
          onPress={()=>calcular("+")} //llamamos el calulcar
          >
